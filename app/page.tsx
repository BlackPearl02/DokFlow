...
export default function LandingPage() {
  return (
    <div className="space-y-12 sm:space-y-16">
      {/* Hero */}
      <section className="relative overflow-hidden rounded-3xl border border-slate-200/50 bg-white px-6 py-16 shadow-lg shadow-slate-200/20 dark:border-slate-800/50 dark:bg-slate-900 dark:shadow-slate-950/20 sm:px-10 sm:py-20 md:py-24">
        <div className="absolute inset-0 bg-[radial-gradient(circle_at_30%_20%,rgba(59,130,246,0.03),transparent_60%)] dark:bg-[radial-gradient(circle_at_30%_20%,rgba(59,130,246,0.05),transparent_60%)]"></div>
        <div className="relative z-10 mx-auto max-w-3xl text-center">
          <div className="mb-6 inline-flex items-center gap-2 rounded-full border border-slate-200 bg-slate-50 px-4 py-1.5 text-sm font-medium text-slate-700 dark:border-slate-700 dark:bg-slate-800 dark:text-slate-300">
          ...
          <div className="mt-10 flex flex-col items-center justify-center gap-4 sm:flex-row">
            <Link
              href="/upload"
              className="group relative w-full overflow-hidden rounded-xl bg-blue-600 px-8 py-4 text-base font-semibold text-white shadow-md shadow-blue-500/20 transition-all duration-300 hover:scale-[1.01] hover:bg-blue-700 hover:shadow-lg hover:shadow-blue-500/25 focus:outline-none focus:ring-2 focus:ring-blue-500 focus:ring-offset-2 active:scale-100 dark:bg-blue-500 dark:shadow-blue-500/15 dark:hover:bg-blue-600 dark:hover:shadow-blue-500/20 sm:w-auto"
            >
      ...
      <section id="jak-to-dziala" className="py-12 sm:py-16">
        ...
        <div className="mt-12 grid gap-6 sm:gap-8 sm:grid-cols-3">
          <div className="rounded-lg border border-slate-200 bg-white p-6 transition-colors hover:border-slate-300 dark:border-slate-700 dark:bg-slate-800 dark:hover:border-slate-600">
            <div className="mb-4 flex items-center gap-3">
              <span className="flex h-8 w-8 shrink-0 items-center justify-center rounded bg-slate-100 text-sm font-semibold text-slate-700 dark:bg-slate-700 dark:text-slate-300">
                1
              </span>
              <h3 className="text-lg font-semibold text-slate-900 dark:text-slate-100">Prześlij plik</h3>
            </div>
          ...
          <div className="rounded-lg border border-slate-200 bg-white p-6 transition-colors hover:border-slate-300 dark:border-slate-700 dark:bg-slate-800 dark:hover:border-slate-600">
            <div className="mb-4 flex items-center gap-3">
              ...
              <h3 className="text-lg font-semibold text-slate-900 dark:text-slate-100">Mapuj i sprawdź</h3>
            </div>
            <p className="text-sm leading-6 text-slate-600 dark:text-slate-300">
          ...
          <div className="rounded-lg border border-slate-200 bg-white p-6 transition-colors hover:border-slate-300 dark:border-slate-700 dark:bg-slate-800 dark:hover:border-slate-600">
            <div className="mb-4 flex items-center gap-3">
              ...
              <h3 className="text-lg font-semibold text-slate-900 dark:text-slate-100">Eksport i pobierz</h3>
            </div>
            <p className="text-sm leading-6 text-slate-600 dark:text-slate-300">
      ...
      {/* Dla kogo */}
      <section className="rounded-3xl border border-slate-200/50 bg-slate-50 px-6 py-12 shadow-md shadow-slate-200/20 dark:border-slate-700/50 dark:bg-slate-800/50 dark:shadow-slate-950/20 sm:px-10 sm:py-16">
        ...
        <ul className="mt-8 grid gap-4 sm:grid-cols-2 lg:grid-cols-4">
          <li className="group flex items-center gap-3 rounded-xl border border-slate-200/50 bg-white p-4 transition-all duration-200 hover:border-slate-300 hover:shadow-md dark:border-slate-700/50 dark:bg-slate-800 dark:hover:border-slate-600">
            <span className="flex h-8 w-8 shrink-0 items-center justify-center rounded-lg bg-slate-600 text-white dark:bg-slate-500" aria-hidden>
      ...
      <section className="rounded-3xl border border-slate-200/50 bg-slate-50 px-6 py-12 shadow-md shadow-slate-200/20 dark:border-slate-700/50 dark:bg-slate-800/50 dark:shadow-slate-950/20 sm:px-10 sm:py-16">
        <div className="text-center mb-10">
          <div className="inline-flex h-16 w-16 items-center justify-center rounded-2xl bg-slate-700 text-white shadow-md shadow-slate-700/20 dark:bg-slate-600 dark:shadow-slate-600/20 mb-6">
        ...
        <ul className="mt-10 space-y-4 text-base text-slate-700 dark:text-slate-300">
          <li className="flex items-start gap-4 rounded-xl border border-slate-200/50 bg-white p-5 dark:border-slate-700/50 dark:bg-slate-800">
            <span className="mt-0.5 flex h-6 w-6 shrink-0 items-center justify-center rounded-full bg-slate-100 text-slate-600 dark:bg-slate-700 dark:text-slate-400" aria-hidden>
              <svg className="h-4 w-4" fill="currentColor" viewBox="0 0 20 20">
