  ...
  return (
    <div className="mx-auto max-w-4xl space-y-8">
      ...
      <section className="rounded-lg border border-blue-200 bg-blue-50 p-6">
        <h2 className="text-xl font-semibold text-blue-900 mb-3">Wymagania przed importem</h2>
      ...
      <section className="rounded-lg border border-slate-200 bg-white p-6">
        <h2 className="text-xl font-semibold text-slate-900 mb-3">Format pliku CSV</h2>
        <p className="text-sm text-slate-600 mb-4">
          Wygenerowany plik ma strukturę zgodną z wymaganiami Optimy:
        </p>
        <div className="rounded border border-slate-200 bg-slate-50 p-4 font-mono text-xs overflow-x-auto">
          <div className="text-slate-600">TOWAR;ILOŚĆ;CENA</div>
          <div className="mt-1 text-slate-800">ABC123;10;99.99</div>
          <div className="text-slate-800">XYZ789;5;149.50</div>
        </div>
        ...
        <div className="space-y-4">
          <div className="flex gap-4">
            ...
            <div className="flex-1">
              <h3 className="font-medium text-slate-900">Otwórz dokument PZ</h3>
          ...
          <div className="flex gap-4">
            ...
            <div className="flex-1">
              <h3 className="font-medium text-slate-900">Wskaż plik CSV</h3>
              <p className="mt-1 text-sm text-slate-600">
          ...
          <div className="flex gap-4">
            ...
            <div className="flex-1">
              ...
              <div className="mt-2 rounded border border-blue-200 bg-blue-50 p-3 text-xs text-blue-800">
          ...
          <div className="flex gap-4">
            ...
            <div className="flex-1">
              <h3 className="font-medium text-slate-900">Zatwierdź import</h3>
              <p className="mt-1 text-sm text-slate-600">
      ...
      <section className="rounded-lg border border-red-200 bg-red-50 p-6">
        <h2 className="text-xl font-semibold text-red-900 mb-4">Rozwiązywanie problemów</h2>
        <div className="space-y-4 text-sm">
          ...
          <div>
            <h3 className="font-medium text-red-900 mb-1">Ilość lub cena nie zaimportowały się poprawnie</h3>
            <ul className="ml-4 list-disc space-y-1 text-red-800">
              <li>Upewnij się, że nie używasz separatorów tysięcy (spacji) w liczbach</li>
              <li>Sprawdź format liczby — użyj kropki jako separatora dziesiętnego (np. <code className="bg-red-100 px-1 rounded">99.99</code>)</li>
          ...
          <div>
            <h3 className="font-medium text-red-900 mb-1">Opcja "Importuj pozycje" nie jest dostępna</h3>
            <ul className="ml-4 list-disc space-y-1 text-red-800">
      ...
      <section className="rounded-lg border border-slate-200 bg-slate-50 p-6">
        <h2 className="text-xl font-semibold text-slate-900 mb-4">Dodatkowe informacje</h2>
      ...
      <section className="rounded-lg border border-slate-200 bg-white p-6 text-center">
        <h2 className="text-xl font-semibold text-slate-900 mb-2">Gotowy do importu?</h2>
        <p className="text-sm text-slate-600 mb-4">
        ...
        <div className="flex flex-wrap justify-center gap-3">
          <Link
            href="/upload"
            className="rounded-lg bg-slate-600 px-6 py-3 font-medium text-white transition-colors duration-200 hover:bg-slate-700 focus:outline-none focus:ring-2 focus:ring-slate-500 focus:ring-offset-2"
          >
            Wygeneruj plik CSV
          </Link>
          <Link
            href="/"
            className="rounded-lg border border-slate-300 px-6 py-3 font-medium text-slate-700 transition-colors duration-200 hover:bg-slate-50 focus:outline-none focus:ring-2 focus:ring-slate-500 focus:ring-offset-2"
          >
            Strona główna
          </Link>
        </div>
